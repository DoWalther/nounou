...
import nounou.io.neuralynx.fileObjects.{FileNEV, FileNeuralynx}
...
//  )
  ...
  override def load(file: File): Array[NNElement] = {
    ...
    val fileAdapter = new FileNEV(file)
    ...
    val eventStarts = new mutable.HashMap[Int, (BigInt, Int, String)]()
    ...
    while(!break){
      ...
      val qwTimeStamp = fHand.readUInt64().toBigInt
    ...
    eventStarts.foreach(  (f: ((Int, (BigInt, Int, String)))) => {
