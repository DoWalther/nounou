...
class NNRangeTest extends FunSuite {
  ...
  test("length odd"){
    ...
    val testFrRange11 = NN.NNRange(0, 4, 1, segment=0)
    val testFrRange21= NN.NNRange(-4, 4, 1, segment=0)
    val testFrRange31= NN.NNRange(0, 7, 1, segment=0)
    val testFrRange41= NN.NNRange(-3, 8, 1, segment=0)

    val testFrRange12 = NN.NNRange(0, 4, 2, segment=0)
    val testFrRange22= NN.NNRange(-4, 4, 2, segment=0)
    val testFrRange32= NN.NNRange(0, 7, 2, segment=0)
    val testFrRange42= NN.NNRange(-3, 8, 2, segment=0)

    val testFrRange52= NN.NNRange(3, 8, 2, segment=0)
    val testFrRange62= NN.NNRange(5, 8, 2, segment=0)
...
//    // </editor-fold>
  ...
  test("length even"){
    ...
    val testFrRange11 = NN.NNRange(0, 3, 1, segment = 0)
    val testFrRange21= NN.NNRange(-3, 3, 1, segment = 0)
    val testFrRange31= NN.NNRange(0, 8, 1, segment = 0)
    val testFrRange41= NN.NNRange(-2, 7, 1, segment = 0)

    val testFrRange12 = NN.NNRange(0, 3, 2, segment = 0)
    val testFrRange22= NN.NNRange(-3, 3, 2, segment = 0)
    val testFrRange32= NN.NNRange(0, 8, 2, segment = 0)
    val testFrRange42= NN.NNRange(-2, 7, 2, segment = 0)

    val testFrRange52= NN.NNRange(3, 8, 2, segment = 0)
    val testFrRange62= NN.NNRange(5, 8, 2, segment = 0)
    val testFrRange72= NN.NNRange(4, 8, 2, segment = 0)
